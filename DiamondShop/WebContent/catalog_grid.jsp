...
<head>
    ...
    <title>Catalog (grid type view)</title>
...
<body>
    ...
    <section id="main">
        <div class="container_12">
		    ...
		    <div class="grid-list">
			<a class="grid current" href="index.jsp"><span></span></a>
			<a class="list" href="catalog_list.jsp"><span></span></a>
		    </div><!-- .grid-list -->
                ...
                <div class="products catalog">
                    ...
                    <article class="grid_3 article">
                        <div class="prev">
                            <a href="product_page.jsp"><img src="img/content/product11.png" alt="Product 11" title=""></a>
                        </div><!-- .prev -->
